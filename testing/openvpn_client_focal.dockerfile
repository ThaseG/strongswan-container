...
# Create a non-root user for running StronSwan
...
COPY --chown=strongswan:strongswan testing/reload-client-focal.sh /home/strongswan/reload-client-focal.sh

# Ensure the script is executable
RUN chmod +x /home/strongswan/reload-client-focal.sh

# Set the entrypoint to the script
ENTRYPOINT ["/home/strongswan/reload-client-focal.sh"]
