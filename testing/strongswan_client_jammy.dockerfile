...
COPY --chown=strongswan:strongswan testing/reload-client-jammy.sh /home/strongswan/reload-client-jammy.sh

# Ensure the script is executable
RUN chmod +x /home/strongswan/reload-client-jammy.sh

# Set the entrypoint to the script
ENTRYPOINT ["/home/strongswan/reload-client-jammy.sh"]
